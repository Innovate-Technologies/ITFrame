 ...
 * @return {Promise}
 */
export const getConfig = (username, callback) => {
 ...
 * @return {Promise}
 */
export const getPlayer = (username, callback) => {
    return nodeify(new Promise((resolve, reject) => {
        wait.launchFiber(function () {
            try {
                let config = wait.for(getConfig, username);
 ...
 * @return {Promise}
 */
export const upsertConfig = (username, config, callback) => {
    return nodeify(new Promise((resolve, reject) => {
 ...
 * @return {Promise}
 */
export const removeConfig = (username, callback) => {
    return nodeify(new Promise((resolve, reject) => {
