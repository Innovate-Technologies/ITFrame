    ...
    castDB.getInfoForUsername(username, function (err, res) {
        ...
        callback(null, {
            ...
            options: [{
                ...
                "name": "ExecStartPre",
                "section": "Service",
                "value": "-/usr/bin/docker pull docker.innovatete.ch/cast",
            }, {
                "name": "ExecStartPre",
                "section": "Service",
                ...
                "name": "ExecStart",
                "section": "Service",
                value: `/usr/bin/docker run -p ${res.input.SHOUTcast.toString()}:${(res.input.SHOUTcast).toString()} -p ${(res.input.SHOUTcast + 1).toString()}:${(res.input.SHOUTcast + 1).toString()} --name ${username} -e username=${username} docker.innovatete.ch/cast`,
            }, {
                "name": "ExecStartPost",
                "section": "Service",
