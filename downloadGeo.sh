...
wget -O GeoLite2-Country.tar.gz https://download.maxmind.com/app/geoip_download?edition_id=GeoLite2-Country&license_key=${GEOLITE_KEY}&suffix=tar.gz || { echo 'Could not download GeoLite2 Country, exiting.' ; exit 1; }
